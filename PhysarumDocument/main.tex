...
\lstdefinelanguage{PseudoCode}{
    morekeywords={Iniciar, programa, Colocar, configuraci\'on, inicial, Ejecutar, Simulador_Physarum, Si, entonces, Guardar, coordenadas, punto, inicial, final, Desplegar, archivo, noFinaliza, Fin},
    sensitive=false,
    morecomment=[l]{//},
...
\input{./util/Glosario}
\begin{document}
    \include{./util/PortadaSup}
    \include{./util/Portada}
    \include{./util/Advertencia.tex}
    \tableofcontents
    \include{./util/SeccionI}
    \include{./util/SeccionII}
