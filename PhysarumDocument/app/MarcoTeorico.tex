...
\label{sec:marco_teorico}
    ...
    \input{./app/marco_teorico/AutomatasCelulares}
    % Introduccion al Physarum Polycephalum
    \input{./app/marco_teorico/PhysarumPolycephalum}
    % SFML
    \input{./app/marco_teorico/ModoGrafico}
    % Raspberry Pi 4
    \input{./app/marco_teorico/RasberyPy}
    % Cubelets
    %\input{./app/marco_teorico/Cubelets}
    % Protocolos de comunicaci\'on
    \input{./app/marco_teorico/ProtocolosComunicacion}
